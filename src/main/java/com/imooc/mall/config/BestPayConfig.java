...
public class BestPayConfig {
    ...
    public BestPayService bestPayService(){
        ...
        //支付商户资料
        wxPayConfig.setMchId("1483469312");  //商户id， 不能错 错就报错
        wxPayConfig.setMchKey("098F6BCD4621D373CADE4E832627B4F6"); //商户key不能错，错就报错b

        //接受支付异步通知的平台,必须要外网，不带参数，方法另外写
        wxPayConfig.setNotifyUrl("http://33r9o84153.zicp.vip/pay/notify");
        ...
        //回调函数
        aliPayConfig.setNotifyUrl("http://33r9o84153.zicp.vip/pay/notifyAli");
